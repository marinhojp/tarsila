                ...
                for row in rows[1:]:
                    ...
                    if re.search(r'\b' + re.escape(nome_museu_normalized) + r'\b', user_input_normalized):
                        ...
                        endereco_respostas = [
                            ...
                            f"O {nome_museu} fica em {logradouro}, no bairro {bairro}."
                        ]
                        telefone_respostas = [
                            ...
                            f"Se você quiser ligar para o {nome_museu} entre em contato pelo número {telefone}."
                            f"Aqui está o contato do {nome_museu}: {telefone}."
                        ]
                        site_respostas = [
                        ...
                        # Seleciona a resposta de acordo com o tipo de informação solicitada
                        if "endereco" in user_input_normalized or "logradouro" in user_input_normalized:
                            ...
                            # Caso o usuário pergunte somente pelo nome do museu
