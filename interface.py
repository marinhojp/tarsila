...
class Chatbot:
    def __init__(self, master):
        ...
        self.text_area.insert(ctk.END, "Olá, eu sou o Botnik! Seja qual for sua pergunta, estou aqui para ajudar. Vamos começar?\n")
        ...
        # Botão de envio
        self.send_button = ctk.CTkButton(master, text="Enviar", fg_color="black", command=self.process_input)
